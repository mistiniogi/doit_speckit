...
export function GoalCard({ goal, onComplete, onDelete, isDragging = false }: GoalCardProps) {
  ...
  return (
    <>
      <Card
        className={`${bgColor} p-4 border border-gray-200 rounded-lg cursor-grab hover:shadow-md transition-shadow ${
